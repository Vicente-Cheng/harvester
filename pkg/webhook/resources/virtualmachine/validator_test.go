...
func Test_virtualMachineValidator_duplicateMacAddress(t *testing.T) {
	...
	validator := NewValidator(nil, nil, nil, nil, nil, nil, nil, fakeVMCache, nil, fakeNadCache, nil).(*vmValidator)
...
func TestVmValidator_Update(t *testing.T) {
	...
	validator := NewValidator(fakeNSCache, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil).(*vmValidator)
